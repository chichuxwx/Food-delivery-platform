...
namespace {
struct qt_meta_tag_ZN13inform_changeE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13inform_changeE = QtMocHelpers::stringData(
    "inform_change",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13inform_changeE[] = {
...
Q_CONSTINIT const QMetaObject inform_change::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13inform_changeE.offsetsAndSizes,
    qt_meta_data_ZN13inform_changeE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13inform_changeE_t,
        // Q_OBJECT / Q_GADGET
...
void *inform_change::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13inform_changeE.stringdata0))
