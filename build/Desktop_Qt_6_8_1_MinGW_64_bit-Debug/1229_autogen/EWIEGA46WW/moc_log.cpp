...
static constexpr auto qt_meta_stringdata_ZN3logE = QtMocHelpers::stringData(
    "log"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN3logE[] = {
...
Q_CONSTINIT const QMetaObject log::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN3logE.offsetsAndSizes,
    qt_meta_data_ZN3logE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN3logE_t,
        // Q_OBJECT / Q_GADGET
...
void *log::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN3logE.stringdata0))
