...
static constexpr auto qt_meta_stringdata_ZN12secondwindowE = QtMocHelpers::stringData(
    "secondwindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12secondwindowE[] = {
...
Q_CONSTINIT const QMetaObject secondwindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12secondwindowE.offsetsAndSizes,
    qt_meta_data_ZN12secondwindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12secondwindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *secondwindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12secondwindowE.stringdata0))
