...
namespace {
struct qt_meta_tag_ZN7addressE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN7addressE = QtMocHelpers::stringData(
    "address",
...
Q_CONSTINIT static const uint qt_meta_data_ZN7addressE[] = {
...
Q_CONSTINIT const QMetaObject address::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7addressE.offsetsAndSizes,
    qt_meta_data_ZN7addressE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7addressE_t,
        // Q_OBJECT / Q_GADGET
...
void *address::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7addressE.stringdata0))
