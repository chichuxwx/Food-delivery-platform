...
public:
    ...
    void setupUi(QWidget *OrderStatus)
    {
        ...
        pushButton_4 = new QPushButton(OrderStatus);
        pushButton_4->setObjectName("pushButton_4");
        pushButton_4->setGeometry(QRect(500, 760, 56, 18));
        pushButton_2 = new QPushButton(OrderStatus);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(50, 760, 56, 18));
        pushButton_3 = new QPushButton(OrderStatus);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(270, 760, 56, 18));
        pushButton = new QPushButton(OrderStatus);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(20, 10, 56, 18));
    ...
    {
        OrderStatus->setWindowTitle(QCoreApplication::translate("OrderStatus", "Form", nullptr));
