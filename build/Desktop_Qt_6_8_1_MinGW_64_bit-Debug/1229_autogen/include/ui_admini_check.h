...
public:
    ...
    void setupUi(QWidget *admini_check)
    {
        ...
        label->setGeometry(QRect(250, 130, 200, 50));
        label->setMinimumSize(QSize(200, 50));
        label_2 = new QLabel(admini_check);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(220, 230, 61, 16));
        textEdit = new QTextEdit(admini_check);
        textEdit->setObjectName("textEdit");
        textEdit->setGeometry(QRect(280, 230, 104, 16));
        groupBox = new QGroupBox(admini_check);
        groupBox->setObjectName("groupBox");
        groupBox->setGeometry(QRect(230, 300, 151, 101));
        ...
        pushButton->setGeometry(QRect(40, 750, 56, 18));
        pushButton_3 = new QPushButton(admini_check);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(490, 750, 56, 18));
        pushButton_4 = new QPushButton(admini_check);
        pushButton_4->setObjectName("pushButton_4");
        pushButton_4->setGeometry(QRect(260, 750, 56, 18));
    ...
    void retranslateUi(QWidget *admini_check)
    {
        ...
        label->setText(QCoreApplication::translate("admini_check", "<html><head/><body><p><span style=\" font-size:20pt; font-weight:700;\">\350\264\255\347\211\251\346\227\245\345\277\227\345\210\227\350\241\250</span></p></body></html>", nullptr));
