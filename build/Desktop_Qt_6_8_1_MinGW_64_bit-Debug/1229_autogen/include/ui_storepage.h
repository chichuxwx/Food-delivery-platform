...
public:
    ...
    void setupUi(QWidget *Storepage)
    {
        ...
        label_8->setGeometry(QRect(70, 170, 40, 12));
        ...
        pushButton_7 = new QPushButton(Storepage);
        pushButton_7->setObjectName("pushButton_7");
        pushButton_7->setGeometry(QRect(230, 310, 100, 30));
        pushButton_7->setMinimumSize(QSize(100, 30));
        pushButton_7->setMaximumSize(QSize(100, 30));
        label_11 = new QLabel(Storepage);
        label_11->setObjectName("label_11");
        label_11->setGeometry(QRect(70, 300, 40, 12));
        ...
        spinBox_2 = new QSpinBox(Storepage);
    ...
    void retranslateUi(QWidget *Storepage)
    {
        ...
        label->setText(QCoreApplication::translate("Storepage", "<html><head/><body><p><span style=\" font-size:22pt; font-weight:700;\">\345\225\206\345\256\266\345\220\215\347\247\260</span></p></body></html>", nullptr));
