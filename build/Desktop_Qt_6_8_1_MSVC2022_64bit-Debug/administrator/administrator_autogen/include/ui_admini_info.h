...
public:
    ...
    void setupUi(QWidget *admini_info)
    {
        ...
        admini_info->resize(300, 400);
        admini_info->setMinimumSize(QSize(300, 400));
        pushButton = new QPushButton(admini_info);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(120, 130, 56, 18));
        pushButton_2 = new QPushButton(admini_info);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(120, 160, 56, 18));
        ...
        pushButton_4->setGeometry(QRect(210, 370, 56, 18));
        pushButton_5 = new QPushButton(admini_info);
        pushButton_5->setObjectName("pushButton_5");
        pushButton_5->setGeometry(QRect(120, 370, 56, 18));
