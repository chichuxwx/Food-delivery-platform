...
public:
    ...
    void setupUi(QWidget *admini_info_done)
    {
        ...
        admini_info_done->resize(300, 400);
        admini_info_done->setMinimumSize(QSize(300, 400));
        ...
        groupBox->setGeometry(QRect(80, 100, 120, 121));
    ...
    void retranslateUi(QWidget *admini_info_done)
    {
        ...
        label->setText(QCoreApplication::translate("admini_info_done", "\345\267\262\345\244\204\347\220\206\346\212\225\350\257\211", nullptr));
