...
public:
    ...
    void setupUi(QWidget *DetailedMenu)
    {
        ...
        label_3->setGeometry(QRect(240, 180, 200, 60));
        ...
        label_5 = new QLabel(DetailedMenu);
        label_5->setObjectName("label_5");
        label_5->setGeometry(QRect(60, 300, 200, 60));
        label_5->setMinimumSize(QSize(200, 60));
        label_6 = new QLabel(DetailedMenu);
        label_6->setObjectName("label_6");
        label_6->setGeometry(QRect(80, 340, 200, 40));
        label_6->setMinimumSize(QSize(200, 40));
        label_6->setMaximumSize(QSize(16777215, 40));
        checkBox = new QCheckBox(DetailedMenu);
        checkBox->setObjectName("checkBox");
        checkBox->setGeometry(QRect(100, 380, 60, 16));
        checkBox_2 = new QCheckBox(DetailedMenu);
        checkBox_2->setObjectName("checkBox_2");
        checkBox_2->setGeometry(QRect(180, 380, 60, 16));
        label_7 = new QLabel(DetailedMenu);
        label_7->setObjectName("label_7");
        label_7->setGeometry(QRect(80, 410, 200, 40));
        label_7->setMinimumSize(QSize(200, 40));
        label_7->setMaximumSize(QSize(16777215, 40));
        checkBox_3 = new QCheckBox(DetailedMenu);
        checkBox_3->setObjectName("checkBox_3");
        checkBox_3->setGeometry(QRect(180, 450, 60, 16));
        checkBox_4 = new QCheckBox(DetailedMenu);
        checkBox_4->setObjectName("checkBox_4");
        checkBox_4->setGeometry(QRect(100, 450, 60, 16));
        checkBox_5 = new QCheckBox(DetailedMenu);
        checkBox_5->setObjectName("checkBox_5");
        checkBox_5->setGeometry(QRect(260, 450, 60, 16));
        label_8 = new QLabel(DetailedMenu);
        label_8->setObjectName("label_8");
        label_8->setGeometry(QRect(40, 730, 200, 60));
        label_8->setMinimumSize(QSize(200, 60));
        pushButton = new QPushButton(DetailedMenu);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(450, 710, 120, 80));
        pushButton->setMinimumSize(QSize(120, 80));
    ...
    void retranslateUi(QWidget *DetailedMenu)
    {
        ...
        label_3->setText(QCoreApplication::translate("DetailedMenu", "<html><head/><body><p><span style=\" font-size:26pt; font-weight:700;\">\350\217\234\345\223\201\345\220\215\347\247\260</span></p></body></html>", nullptr));
        ...
        label_8->setText(QCoreApplication::translate("DetailedMenu", "<html><head/><body><p><span style=\" font-size:20pt; font-weight:700;\">\346\200\273\350\256\241\344\273\267\346\240\274\357\274\232</span></p></body></html>", nullptr));
