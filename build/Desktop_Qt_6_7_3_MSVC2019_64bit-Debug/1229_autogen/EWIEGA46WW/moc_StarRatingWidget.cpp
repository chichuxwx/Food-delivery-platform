...
struct qt_meta_stringdata_CLASSStarRatingWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSStarRatingWidgetENDCLASS = QtMocHelpers::stringData(
    "StarRatingWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSStarRatingWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject StarRatingWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSStarRatingWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSStarRatingWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSStarRatingWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *StarRatingWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSStarRatingWidgetENDCLASS.stringdata0))
