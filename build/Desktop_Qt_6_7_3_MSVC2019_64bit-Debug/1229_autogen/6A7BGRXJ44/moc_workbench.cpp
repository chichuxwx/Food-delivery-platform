...
struct qt_meta_stringdata_CLASSpage_workbenchENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSpage_workbenchENDCLASS = QtMocHelpers::stringData(
    "page_workbench",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSpage_workbenchENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject page_workbench::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSpage_workbenchENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSpage_workbenchENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSpage_workbenchENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *page_workbench::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSpage_workbenchENDCLASS.stringdata0))
