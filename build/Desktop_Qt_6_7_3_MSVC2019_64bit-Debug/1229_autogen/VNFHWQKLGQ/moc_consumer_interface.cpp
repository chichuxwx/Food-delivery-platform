...
struct qt_meta_stringdata_CLASSConsumer_interfaceENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSConsumer_interfaceENDCLASS = QtMocHelpers::stringData(
    "Consumer_interface",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSConsumer_interfaceENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Consumer_interface::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSConsumer_interfaceENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSConsumer_interfaceENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSConsumer_interfaceENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Consumer_interface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSConsumer_interfaceENDCLASS.stringdata0))
